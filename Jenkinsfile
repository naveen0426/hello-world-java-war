pipeline
{
    ...
    stages
    {
        ...
        stage('ContinousDeployment')
        {
            steps
            {
               sh label: '', script: 'scp /var/lib/jenkins/workspace/multipipeline_master@2/target/hello-1.16.war ec2-user@18.205.152.8:/opt/tomcat/tomcat/webapps/hello-1.16.war'
            }
        }
