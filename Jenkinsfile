pipeline
{
    ...
    stages
    {
        ...
        stage('ContinousDeployment')
        {
            steps
            {
               sh label: '', script: 'scp /var/lib/jenkins/workspace/multipipeline_master@2/target/hello-1.16.war jenkins@3.93.63.185 /opt/tomcat/tomcat/webapps/hello-1.16.war'
            }
        }
